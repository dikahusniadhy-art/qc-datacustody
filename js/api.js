 ...
 **************************************************************************/
    ...
    async post(
        ...
        try {
             ...
             * ================================================================
             *
             * Tetap menggunakan no-cors karena frontend
             * berjalan dari GitHub Pages dan backend
             ...
             * ================================================================
             *
             * Karena no-cors menghasilkan opaque response,
             * browser tidak dapat membaca response asli
             * dari Google Apps Script.
             *
             * Jadi status di sini berarti request sudah
    ...
    async deleteAgunan(
        ...
        try {
            ...
            err
                ...
                /*
                 * Jika GET gagal karena network,
                 * kita TIDAK boleh menganggap DELETE berhasil.
                 */
                ...
                throw new Error(
                    "Tidak dapat memastikan apakah data berhasil dihapus."
                );
            ...
            if (
                ...
                throw new Error(
                    "Data masih ada di Spreadsheet. Delete gagal."
                );
            ...
            /*
             * ================================================================
             * RESPONSE TIDAK JELAS
             * ================================================================
             */

            throw new Error(
                "Hasil Delete tidak dapat diverifikasi."
            );
